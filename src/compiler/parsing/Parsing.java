...
public class Parsing {
   public int tabParsing[][] = new int[83][51];

   public int producoes[][] = {
    ...
    public Parsing(){
        //inicializar a Matriz de tabParsing com zeros.
        for(int i=0; i<83; i++){
            for(int j=0; j<51; j++){
                tabParsing[i][j] = 0;
            }
        ...
        //inicializar os outros elementos da Matriz de tabParsing.
        tabParsing[51][2] = 1;
        tabParsing[52][2] = 3;
        tabParsing[52][3] = 3;
        tabParsing[52][7] = 2;
